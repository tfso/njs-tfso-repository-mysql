    ...
    executeQuery() {
        return new Promise((resolve, reject) => {
            try {
                ...
                let skip = undefined, skipped = 0, skipOperator = null, take = undefined, taken = 0, takeOperator = null;
                ...
                query.on('end', () => {
                    if (error != null)
                        ...
                        resolve(new recordset_1.RecordSet(records, changedRecords || affectedRecords, (Date.now() - timed), skip != null ? totalPredicateIterations : (totalRecords >= 0 ? totalRecords : undefined)));
                });
            }
            catch (ex) {
                reject(ex);
